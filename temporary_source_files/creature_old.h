...
class Creature_old : public T_turn_based_entity
{
  public:
    Creature_old(int number_of_body_parts, const Sprite_specification& sprite_specification);
...
template <typename T_turn_based_entity>
    requires(std::derived_from<T_turn_based_entity, Turn_based_entity>)
Creature_old<T_turn_based_entity>::Creature_old(int number_of_body_parts, const Sprite_specification& sprite_specification)
...
template <typename T_turn_based_entity>
    requires(std::derived_from<T_turn_based_entity, Turn_based_entity>)
std::shared_ptr<Body_part> Creature_old<T_turn_based_entity>::create_body_part()
{
...
template <typename T_turn_based_entity>
    requires(std::derived_from<T_turn_based_entity, Turn_based_entity>)
void Creature_old<T_turn_based_entity>::add_body_part(std::shared_ptr<Body_part> body_part)
{
...
template <typename T_turn_based_entity>
    requires(std::derived_from<T_turn_based_entity, Turn_based_entity>)
void Creature_old<T_turn_based_entity>::on_body_part_death(std::shared_ptr<Body_part> body_part)
{
}

template <typename T_turn_based_entity>
    requires(std::derived_from<T_turn_based_entity, Turn_based_entity>)
Position Creature_old<T_turn_based_entity>::get_head_position() const
{
...
template <typename T_turn_based_entity>
    requires(std::derived_from<T_turn_based_entity, Turn_based_entity>)
void Creature_old<T_turn_based_entity>::take_turn()
{
}
