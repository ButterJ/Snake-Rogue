...
void Snake_factory::create_creature(int number_of_body_parts)
{
...
std::shared_ptr<Body_part> Snake_factory::create_body_part()
{
...
std::shared_ptr<Snake> Snake_factory::get_creature() const
{
    return creature;
}
